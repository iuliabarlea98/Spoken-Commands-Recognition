...
import json
import numpy as np
DATASET_PATH = "D:/mini_speech_commands"
JSON_PATH = "data.json"
        ...
        if dirpath is not dataset_path:
            ...
            for f in filenames:
                ...
                if len(signal) >= SAMPLES_TO_CONSIDER:
                    ...
                    data["1stdeltaMFCCs"].append(MFCCs_Delta.T.tolist())
                    data["2nddeltaMFCCs"].append(MFCC_Delta2.T.tolist())
                    data["allMFCCs"].append(allMFCCs.T.tolist())
